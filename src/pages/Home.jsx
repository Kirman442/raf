                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-8 text-center tab-style3" id="animated-tab1">
                            ...
                            <ul className="nav nav-tabs margin-50px-bottom sm-margin-30px-bottom text-uppercase alt-font text-small font-weight-600 justify-content-center flex-column flex-md-row" role="tablist">
                                <li className="nav-item" role="presentation"><a href="#tab3_sec1" data-bs-toggle="tab" className="text-medium nav-link text-medium-gray active" aria-selected="true" role="tab" >Арбитраж</a></li>
                                <li className="nav-item" role="presentation"><a href="#tab3_sec2" data-bs-toggle="tab" className="text-medium nav-link text-medium-gray " aria-selected="false" tabindex="-1" role="tab" >Банкротство</a></li>
                            </ul>
                            {/* <!-- end tab navigation --> */}
                        </div>
                    </div>
